...
public class ExchengedFragment extends Fragment {
    ...
    private Response.Listener<String> listener = new Response.Listener<String>() {
        ...
        public void onResponse(String s) {
            try {
                ...
                listView.setAdapter(new ExchangedAdapter(getActivity(), goods));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Fragment fragment = new EditExchengedFragment();
                Bundle bundle = new Bundle();
                Goods good = ((ExchangedAdapter)listView.getAdapter()).getItem(position);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode != 1) {
            ((ExchangedAdapter) listView.getAdapter()).notifyDataSetChanged();
        } else {
            send();
        }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String newText) {
                ExchangedAdapter adapter = (ExchangedAdapter) listView.getAdapter();
                if (adapter != null) {
    ...
    private void send() {
        ...
        serverApi.sendGroupExchange(userId, shopId, createJSONArray(), new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                try {
