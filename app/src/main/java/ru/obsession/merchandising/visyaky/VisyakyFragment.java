...
public class VisyakyFragment extends Fragment {
    ...
    private Response.Listener<String> listener = new Response.Listener<String>() {
        ...
        public void onResponse(String s) {
            try {
                ...
                listView.setAdapter(new VisyakyAdapter(getActivity(), goods));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Fragment fragment = new EditVisyakyFragment();
                Bundle bundle = new Bundle();
                Goods good = ((VisyakyAdapter)listView.getAdapter()).getItem(position);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode != 1) {
            ((VisyakyAdapter) listView.getAdapter()).notifyDataSetChanged();
        } else {
            send();
        }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String newText) {
                VisyakyAdapter adapter = (VisyakyAdapter) listView.getAdapter();
                if (adapter != null) {
    ...
    private void send() {
        ...
        serverApi.sendGroupDangling(userId, shopId, createJSONArray(), new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                try {
        ...
        for (Goods good : goods) {
            if (good.isFiel()) {
                ...
                try {
                    ...
                    object.put("reason", good.resone);
                    object.put("updating", good.date);
                    object.put("causer", good.responsible);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
